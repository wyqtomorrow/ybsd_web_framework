                    ...
                    callback: function () {
                        ...
                        setTimeout(function () {
                            if (isLastPage) {
                                ...
                                queryGoodsList('QG', currentPageNum + 1);
...
$(function () {
    ...
    //初始化列表
    queryGoodsList('QG', currentPageNum);
...
function initPage() {
    ...
    $("#qrBtn").on("tap", function (e) {
        ...
        $(".t_nav i").attr("class", "iconfont icon-xiasanjiao-copy f18 black3");
        //重量复制
        $("#q_goods_max_weight").val($("#weight_max").val());
        $("#q_goods_min_weight").val($("#weight_min").val());
        //清空列表
        $("#content_list").html("");
        queryGoodsList('QG', 1);
    });
...
function queryGoodsList(type, pageNum) {
    ...
    queryConditionForm.goodsCategory = $("#q_goods_category").val();
    queryConditionForm.goodsKinds = $("#q_goods_kinds").val();
    queryConditionForm.goodsGender = $("#q_goods_gender").val();
...
$("#content_list").on("tap", "li", function () {
    ...
    self.location.href = "/mob/goods/selectGoodsById/" + id + "/purchase";
});
