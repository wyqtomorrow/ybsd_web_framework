package com.gqcp.wechat.base;

import com.gqcp.common.wechat.exception.WxRuntimeException;
import com.gqcp.common.wechat.util.XmlObjectMapper;
...
public class CorpSetting {
    ...
    private static void loadFromClasspath() {
        try {
            InputStream inputStream = Thread.currentThread().getContextClassLoader().getResourceAsStream("wx-qy-settings.xml");
            ...
            logger.error("read settings from wx-qy-settings.xml or wx-qy-settings.xml failed:", e);
        }
    }
